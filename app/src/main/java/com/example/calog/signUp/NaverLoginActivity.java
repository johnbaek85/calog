...
public class NaverLoginActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    static final String CLIENT_SECRET = "xxx";
    ...
    private class RequestApiTask extends AsyncTask<Void, Void> {
       /* @Override
