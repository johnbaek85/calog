            ...
            case R.id.adjust:
                ...
                call.enqueue(new Callback<UserVO>() {
                    ...
                    public void onResponse(Call<UserVO> call, Response<UserVO> response) {
                        ...
                        intent = new Intent(MyFitnessListActivity.this, UpdateUserInfoActivity.class);
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        ...
                        call.enqueue(new Callback<Void>() {
                            ...
                            public void onResponse(Call<Void> call, Response<Void> response) {
                                Toast.makeText(MyFitnessListActivity.this,
...
//                                 Toast.LENGTH_SHORT).show();
    ...
    public void connect(final int type) {
        ...
        switch (type) {
            case 1:
                Call<List<FitnessVO>> cardiCall = rs.OneDayCardioList(str_user_id, fitness_date);
                ...
                break;
            case 2:
                Call<List<FitnessVO>> weightCall = rs.OneDayWeightList(str_user_id, fitness_date);
