...
public class MyMediaRecorder {
    ...
    public boolean startRecorder(){
        ...
        try {
            ...
            mMediaRecorder.setAudioSource(MediaRecorder.AudioSource.MIC);//마이크
            mMediaRecorder.setOutputFormat(MediaRecorder.OutputFormat.THREE_GPP);//녹음
            mMediaRecorder.setAudioEncoder(MediaRecorder.AudioEncoder.AMR_NB);//오디오 코덱
